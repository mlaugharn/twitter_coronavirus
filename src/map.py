        ...
        with archive.open(filename) as f:
            ...
            for line in f:
                ...
                for hashtag in hashtags:
                    lang = tweet['lang']
                    country_present = 'place' in tweet and tweet['place'] and 'country_code' in tweet['place']
                    if country_present: country = tweet['place']['country_code']
                    if hashtag in text:
                        counter_lang[hashtag][lang] += 1
                        if country_present:
                                                        counter_country[hashtag][country] += 1
                    counter_lang['_all'][lang] += 1
                    if country_present: counter_country['_all'][country] += 1
